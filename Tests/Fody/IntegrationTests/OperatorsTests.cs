...
namespace PostSharp.Community.StructuralEquality.Tests.Fody.IntegrationTests
{
    public class OperatorsTests
    {
        ...
        {
            var first = new OnlyOperator();
            var second = new OnlyOperator();
...
var second = new OnlyOperator();
        ...
        {
            var first = new StructWithOnlyOperator();
var second = new StructWithOnlyOperator();
...
var second = new GuidClass();
        ...
        {
            var first = new ObjectCollection();
var second = new ObjectCollection();
...
var second = new ObjectCollection();
        ...
        {
            var type = typeof(DoNotAddEqualityOperators);
        ...
        {
            var first = new DoNotReplaceEqualityOperators();
var second = new DoNotReplaceEqualityOperators();
